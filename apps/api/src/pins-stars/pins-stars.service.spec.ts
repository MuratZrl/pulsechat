      ...
      prisma.star.findMany.mockResolvedValue([
        {
          ...
          message: {
            ...
            sender: {
              name: 'Alice',
              avatarUrl: 'https://test-r2.example/avatars/alice.png',
              avatarPreset: null,
            },
          },
      ...
      expect(result).toEqual([
        {
          ...
          message: {
            ...
            text: 'Hello world',
            senderName: 'Alice',
            senderAvatarUrl: 'https://test-r2.example/avatars/alice.png',
      ...
      prisma.star.findMany.mockResolvedValue([
        {
          ...
          message: {
            ...
            isDeleted: true,
            senderId: 'user-2',
            sender: { name: 'Alice', avatarUrl: null, avatarPreset: null },
          },
          room: { id: 'room-1', name: 'General', type: 'channel' },
        },
        {
          ...
          message: {
            ...
            isDeleted: false,
            senderId: 'user-3',
            sender: { name: 'Bob', avatarUrl: null, avatarPreset: null },
          },
          room: { id: 'room-1', name: 'General', type: 'channel' },
        },
      ]);
